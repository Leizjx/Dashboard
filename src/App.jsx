      ...
      <div className="container">
        ...
        <div className="app-container">
          <div className="section">
            <h2>TÀI KHOẢN</h2>
            <img src="https://cdn.kona-blue.com/upload/kona-blue_com/post/images/2024/09/19/465/avatar-trang-7.jpg" alt="" width={200} height={200} />
        ...
        <div className="charts">
          ...
          <div className="infor-chart">
              <h3>Biểu Đồ Doanh Số Từ Tháng 1 Đến Tháng 12 Năm 2024</h3>
              <h3>Tổng Đơn Hàng Đã Thành Toán: 11,065,195</h3>
              <h3>Tổng Doanh Số Tất Cả Các Dịch Vụ(Không tính tên miền và VAT):8,296,000</h3>
          </div>
        </div>
         <div className="dashboard">
